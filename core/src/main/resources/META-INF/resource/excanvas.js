...
(function () {
  ...
  if (/MSIE/.test(navigator.userAgent) && !window.opera) {
    document.attachEvent("onreadystatechange", new Function("G_vmlCanvasManager.init(document)"));
    window.attachEvent("onunload", new Function("G_vmlCanvasManager.cleanup(document)"));
  }
