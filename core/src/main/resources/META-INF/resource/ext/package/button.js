...
this.iconCls=cls;},beforeDestroy:function(){var btn=this.el.child(this.buttonSelector);if(btn){btn.removeAllListeners();}
...
if(this.toggleHandler){this.toggleHandler.call(this.scope||this,this,state);}}},focus:function(){this.el.child(this.buttonSelector).focus();},onDisable:function(){if(this.el){if(!Ext.isIE6){this.el.addClass("x-item-disabled");}
