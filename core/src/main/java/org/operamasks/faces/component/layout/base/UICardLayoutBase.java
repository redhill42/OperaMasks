/*
 * $Id: UICardLayoutBase.java,v 1.3 2008/03/20 01:44:09 lishaochuan Exp $
 *
...
import org.operamasks.faces.render.layout.CardLayoutRenderHandler;
import org.operamasks.faces.tools.annotation.ComponentMeta;

@ComponentMeta(tagName="cardLayout")
@Component(renderHandler=CardLayoutRenderHandler.class)
public abstract class UICardLayoutBase extends UILayout {
    @ExtConfigOption protected Integer activeItem;
    @ExtConfigOption protected Boolean deferredRender;
    
    @Operation("setActiveItem")
    public void activeItem(Integer item){}
}
