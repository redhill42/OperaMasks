/*
 * $Id: UITextAreaBase.java,v 1.2 2008/03/11 02:51:18 lishaochuan Exp $
 *
...
import org.operamasks.faces.render.form.TextAreaRenderHandler;
import org.operamasks.faces.tools.annotation.ComponentMeta;

@ComponentMeta(tagName="textArea")
@Component(renderHandler=TextAreaRenderHandler.class)
public abstract class UITextAreaBase extends UITextField{
    @ExtConfigOption protected Integer growMax;
    @ExtConfigOption protected Integer growMin;
    @ExtConfigOption protected Boolean preventScrollbars;
}
