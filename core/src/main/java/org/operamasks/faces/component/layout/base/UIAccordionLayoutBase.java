/*
 * $Id: UIAccordionLayoutBase.java,v 1.3 2008/03/20 01:44:09 lishaochuan Exp $
 *
...
import org.operamasks.faces.render.layout.AccordionLayoutRenderHandler;
import org.operamasks.faces.tools.annotation.ComponentMeta;

@ComponentMeta(tagName="accordionLayout")
@Component(renderHandler=AccordionLayoutRenderHandler.class)
public abstract class UIAccordionLayoutBase extends UILayout {
    @ExtConfigOption protected Boolean titleCollapse;
    @ExtConfigOption protected Boolean animate;
    @ExtConfigOption protected Boolean activeOnTop;
}
