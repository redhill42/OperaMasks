/*
 * $Id: UICommandMenuItem.java,v 1.4 2007/12/11 04:20:12 jacky Exp $
 *
...
public class UICommandMenuItem extends HtmlCommandLink
{
    public static final String COMPONENT_TYPE = "org.operamasks.faces.widget.CommandMenuItem";
    ...
    public UICommandMenuItem() {
        setRendererType(MENU_RENDERER_TYPE);
    }
