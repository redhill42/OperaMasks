/*
 * $Id: UICheckMenuItem.java,v 1.3 2007/07/02 07:38:18 jacky Exp $
 *
...
public class UICheckMenuItem extends HtmlSelectBooleanCheckbox
{
    public static final String COMPONENT_TYPE = "org.operamasks.faces.widget.CheckMenuItem";

    public static final String DEFAULT_RENDERER_TYPE = "javax.faces.Checkbox";
    public static final String MENU_RENDERER_TYPE = "org.operamasks.faces.widget.CheckMenuItem";

    public UICheckMenuItem() {
