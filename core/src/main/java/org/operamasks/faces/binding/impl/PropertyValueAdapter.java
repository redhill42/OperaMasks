/*
 * $Id: PropertyValueAdapter.java,v 1.2 2007/10/15 21:09:47 daniel Exp $
 *
...
class PropertyValueAdapter extends AbstractValueAdapter
{
    private final PropertyBinding binding;
    private final ModelBean bean;

    public PropertyValueAdapter(PropertyBinding binding, ModelBean bean) {
